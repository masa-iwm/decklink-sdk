...
HDRVideoFrame::HDRVideoFrame(CComPtr<IDeckLinkMutableVideoFrame> frame, HDRMetadata& metadata) 
...
HRESULT HDRVideoFrame::GetString(BMDDeckLinkFrameMetadataID metadataID, BSTR* value)
{

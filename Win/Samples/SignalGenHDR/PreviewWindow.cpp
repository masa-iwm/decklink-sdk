...
PreviewWindow::PreviewWindow()
	: m_refCount(1), m_deckLinkScreenPreviewHelper(nullptr), m_previewBox(nullptr), m_previewBoxDC(nullptr), m_openGLctx(nullptr)
{}
...
bool		PreviewWindow::init(CStatic *previewBox)
{
	...
	if (m_deckLinkScreenPreviewHelper.CoCreateInstance(CLSID_CDeckLinkGLScreenPreviewHelper, nullptr, CLSCTX_ALL) != S_OK)
		return false;
...
HRESULT			PreviewWindow::DrawFrame(IDeckLinkVideoFrame* theFrame)
{
	...
	if ((m_deckLinkScreenPreviewHelper == nullptr) || (m_previewBoxDC == nullptr) || (m_openGLctx == nullptr))
		return E_FAIL;

...
private:
	...
	int 						m_maxRollingSamples;
	std::deque<BMDTimeValue>	m_rollingSamples;
	BMDTimeValue				m_rollingAggregateLatency;
	
	// Minimum/maximum latency
	BMDTimeValue				m_maxLatency;
	BMDTimeValue				m_minLatency;

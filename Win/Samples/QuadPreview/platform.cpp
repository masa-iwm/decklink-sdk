...
HRESULT GetDeckLinkOpenGLScreenPreviewHelper(com_ptr<IDeckLinkGLScreenPreviewHelper>& screenPreviewHelper)
{
	...
	// Create an IDeckLinkIterator object to enumerate all DeckLink cards in the system
	result = CoCreateInstance(CLSID_CDeckLinkGLScreenPreviewHelper, nullptr, CLSCTX_ALL, IID_IDeckLinkGLScreenPreviewHelper, (void**)screenPreviewHelper.releaseAndGetAddressOf());
	if (FAILED(result))
	{

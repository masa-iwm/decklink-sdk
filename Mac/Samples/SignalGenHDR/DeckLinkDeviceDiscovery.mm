...
DeckLinkDeviceDiscovery::DeckLinkDeviceDiscovery(SignalGenHDRAppDelegate* delegate)
: m_uiDelegate(delegate), m_deckLinkDiscovery(nullptr), m_refCount(1)
{
...
HRESULT DeckLinkDeviceDiscovery::DeckLinkDeviceArrived (/* in */ IDeckLink* deckLink)
{
	...
	dispatch_async(dispatch_get_main_queue(), ^{
		[m_uiDelegate addDevice:com_ptr<IDeckLink>(deckLink)];
	});
...
{
	dispatch_async(dispatch_get_main_queue(), ^{
		[m_uiDelegate removeDevice:com_ptr<IDeckLink>(deckLink)];
	});
	return S_OK;
}
